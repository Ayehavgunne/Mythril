...
SINGLE_OPERATORS = (LPAREN, RPAREN, LSQUAREBRACKET, RSQUAREBRACKET, LCURLYBRACKET, RCURLYBRACKET, BINARY_AND, BINARY_OR, BINARY_XOR, BINARY_ONES_COMPLIMENT, COMMA, DECORATOR)
