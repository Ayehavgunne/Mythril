...
const string OPERATORS[51] = {
	...
	BINARY_RIGHT_SHIFT, AND, OR, NOT, IN, NOT_IN, IS, IS_NOT, AMPERSAND, PIPE, LPAREN,
	RPAREN, LSQUAREBRACKET, RSQUAREBRACKET, LCURLYBRACKET, RCURLYBRACKET, COMMA, COLON,
	DOT, RANGE, ELLIPSIS, ARROW, CAST, ASSIGN, PLUS_ASSIGN, MINUS_ASSIGN, MUL_ASSIGN,
	DIV_ASSIGN, FLOORDIV_ASSIGN, MOD_ASSIGN, POWER_ASSIGN, EQUALS, NOT_BANG, NOT_EQUALS,
	LESS_THAN, GREATER_THAN, LESS_THAN_OR_EQUAL_TO, GREATER_THAN_OR_EQUAL_TO, DECORATOR,
};
...
const string KEYWORDS[43] = {
	IF, ELSE_IF, ELSE, WHILE, FOR, SWITCH, CASE, DEF, CLASS, SUPER, THIS, RETURN, TEST,
	TRY, CATCH, FINALLY, THEN, YIELD, BREAK, CONTINUE, DEL, MATCH, IMPORT, WILDCARD,
	FROM, WITH, AS, PASS, VOID, RAISE, ACTOR, CONST, REQUIRE, ENSURE, OVERRIDE, DOC,
	ABSTRACT, GETTER, SETTER, ASSERT, DEFAULT, NEW, ALIAS,
};
...
const string TYPES[19] = {
	ANY, INT, INT8, INT32, INT64, INT128, DEC, FLOAT, COMPLEX, STR, BOOL, BYTES, ARRAY,
	LIST, SET, DICT, ENUM, FUNC, STRUCT
};
